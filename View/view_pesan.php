            ...
            <div class="col-6">
                <form class="my-5" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="nama-mobil" type="text" class="form-control" id="nama-mobil" placeholder="Nama Mobil" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input name="lama-sewa" type="number" class="form-control" id="lama-sewa" placeholder="Lama Sewa (Hari)">
                        </div>
                    </div>
                    <div class="form-group row">
